...
const toolboxItems = [
  ...
  { title: 'ReactJS', iconType: ReactJSIcon },
  { title: 'Redux', iconType: ReduxIcon },
  { title: 'Framer Motion', iconType: FramerMotionIcon },
...
const hobbies = [
  ...
  { title: 'Anime', emoji: '😍', left: '10%', top: '35%' },
  { title: 'K-Dramas', emoji: '😍', left: '35%', top: '40%' },
  { title: 'Music', emoji: '🎵', left: '70%', top: '45%' },
  { title: 'Dancing', emoji: '🕺', left: '5%', top: '65%' },
  { title: 'Fitness', emoji: '🏋️‍♀️', left: '45%', top: '70%' },
];
